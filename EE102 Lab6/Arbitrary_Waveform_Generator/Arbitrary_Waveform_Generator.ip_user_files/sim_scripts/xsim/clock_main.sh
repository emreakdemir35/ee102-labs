...
#
# Script generated by Vivado on Sun Apr 06 20:40:57 +0300 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clock_main.sh
...
#
# Usage        : clock_main.sh
#                clock_main.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_main.sh [-reset_run]
#                clock_main.sh [-reset_log]
#                clock_main.sh [-help]
#
...
# script info
echo -e "clock_main.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_main.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot clock_main xil_defaultlib.clock_main xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock_main -key {Behavioral:sim_1:Functional:clock_main} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clock_main.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clock_main.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clock_main.sh [-help]\n\
Usage: clock_main.sh [-step]\n\
Usage: clock_main.sh [-lib_map_path]\n\
Usage: clock_main.sh [-reset_run]\n\
Usage: clock_main.sh [-reset_log]\n\
Usage: clock_main.sh [-keep_index]\n\
Usage: clock_main.sh [-noclean_files]\n\n\
