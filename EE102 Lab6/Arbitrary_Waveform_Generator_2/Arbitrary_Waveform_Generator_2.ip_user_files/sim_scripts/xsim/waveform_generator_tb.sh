...
#
# Script generated by Vivado on Mon Apr 07 20:46:40 +0300 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : waveform_generator_tb.sh
...
#
# Usage        : waveform_generator_tb.sh
#                waveform_generator_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                waveform_generator_tb.sh [-reset_run]
#                waveform_generator_tb.sh [-reset_log]
#                waveform_generator_tb.sh [-help]
#
...
# script info
echo -e "waveform_generator_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./waveform_generator_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot waveform_generator_tb xil_defaultlib.waveform_generator_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim waveform_generator_tb -key {Behavioral:sim_1:Functional:waveform_generator_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb waveform_generator_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./waveform_generator_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: waveform_generator_tb.sh [-help]\n\
Usage: waveform_generator_tb.sh [-step]\n\
Usage: waveform_generator_tb.sh [-lib_map_path]\n\
Usage: waveform_generator_tb.sh [-reset_run]\n\
Usage: waveform_generator_tb.sh [-reset_log]\n\
Usage: waveform_generator_tb.sh [-keep_index]\n\
Usage: waveform_generator_tb.sh [-noclean_files]\n\n\
