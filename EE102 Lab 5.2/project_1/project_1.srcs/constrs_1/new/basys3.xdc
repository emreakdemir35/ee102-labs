...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {anode[6]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[6]}]
set_property PACKAGE_PIN W6 [get_ports {anode[5]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[5]}]
set_property PACKAGE_PIN U8 [get_ports {anode[4]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[4]}]
set_property PACKAGE_PIN V8 [get_ports {anode[3]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[3]}]
set_property PACKAGE_PIN U5 [get_ports {anode[2]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[2]}]
set_property PACKAGE_PIN V5 [get_ports {anode[1]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[1]}]
set_property PACKAGE_PIN U7 [get_ports {anode[0]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {anode[0]}] 

set_property PACKAGE_PIN V7 [get_ports dp]							
	set_property IOSTANDARD LVCMOS33 [get_ports dp]

set_property PACKAGE_PIN U2 [get_ports {cat[0]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {cat[0]}]
set_property PACKAGE_PIN U4 [get_ports {cat[1]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {cat[1]}]
set_property PACKAGE_PIN V4 [get_ports {cat[2]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {cat[2]}]
set_property PACKAGE_PIN W4 [get_ports {cat[3]}]
